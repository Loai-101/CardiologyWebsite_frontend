    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-section footer-services">
          <h3>Our Services</h3>
          <ul className="footer-links">
            <li><a href="#" className="footer-link">Cardiac Consultation</a></li>
            <li><a href="#" className="footer-link">Heart Surgery</a></li>
            <li><a href="#" className="footer-link">Cardiac Rehabilitation</a></li>
            <li><a href="#" className="footer-link">Emergency Care</a></li>
            <li><a href="#" className="footer-link">Preventive Cardiology</a></li>
          </ul>
        </div>
           ...
           <p><FaEnvelope /> info@cardiologyhospital.com</p>
